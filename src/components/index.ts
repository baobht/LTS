...
export { default as Header } from './lab/Header/Header';
// from lab
export { default as ImageEditor } from './lab/ImageEditor/ImageEditor';
export { default as ProjectCard } from './lab/ProjectCard/ProjectCard';
export { default as ScrollView } from './lab/ScrollView/ScrollView';
export { default as StripeCard } from './lab/StripeCard/StripeCard';
...
export { default as OTPInput } from './lab/OTPInput/OTPInput';
