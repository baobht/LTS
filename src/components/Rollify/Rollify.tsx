...
const Rollify = () => {
	...
	useEffect(() => {
		...
		const handleHighlightText = (selectionText: string, range: Range) => {
			...
			if (
				...
				console.log('🚀 ~ file: AddBroll.tsx:186 ~ handleHighlightText ~ newSpanElement:', newSpanElement);
	...
	return (
		<section className="flex flex-wrap items-center bg-white pb-28 pt-6">
			<div className="flex flex-wrap-reverse items-center w-full xl:w-9/12">
				<div className="w-full xl:w-2/5 px-2 pr-3">
					<h2 className="text-center text-black font-bold mb-3 text-2xl select-none">Highlight text to add B-roll</h2>
					<div className="transcript-container relative rounded-[18px] flex flex-col items-center bg-[#F8FAFF] max-h-[calc(100vh-205px)] min-h-[calc(100vh-205px)] py-[17px] pl-8 pr-3 z-[1]">
						<Button
							variant="contained"
							type="button"
